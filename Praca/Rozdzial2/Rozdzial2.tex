...
\begin{figure}[tbph]
    \centering
    \includegraphics[width=0.8\textwidth]{AABB2} 
    \caption{Obrazek przedstawiający przecięcie AABB~\cite{aabb}.}
    \label{fig:aabbPic2}
\end{figure}
...
\begin{figure}[tbph]
    ...
    \caption{Rysunek przedstawiający powierzchnię A i B. [Opracowanie własne]}
    \label{fig:bvhAB}
\end{figure}