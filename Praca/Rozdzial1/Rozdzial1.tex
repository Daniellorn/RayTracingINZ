...
\begin{figure}[tbph]
    ...
    \caption{Rysunek przedstawia ideę ray tracingu. [Opracowanie własne]}
    \label{fig:RT}
\end{figure}
...
Równanie~\eqref{eq:T} może mieć rozwiązania dodatnie jak i ujemne. Silnik, aby poprawnie generować obrazy dla wielu sfer w scenie, potrzebuje wartości najmniejszej i dodatniej (wartość ujemna świadczy o tym, że punkt przecięcia promienia ze sferą jest za kamerą). W ramach oznaczenia przypadku braku rozwiązania równania~\eqref{eq:T} z funkcji zwracana jest wartość $-1.0$.  
